...
void Client::listenBroadcastIndex(string inputDir, string inputDir1, string inputDir2, string inputDir3, string inputDir4, string inputDir5)
{
	int nowRegionId;
	Region* nowRegion;
	int lineNumber = 0;
...
void Client::computeKNNAnswer(string inputDir, string inputDir1, string inputDir2, string inputDir3, string inputDir4, string inputDir5, string inputDir6, string inputDir7, int queryAmountK, int startRegionId)
{
