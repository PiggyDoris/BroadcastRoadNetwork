...
public:
	...
	void listenBroadcastIndex(string, string, string, string, string, string);
	void listenBroadcastData(string);
	void locateQueryPointRegion();
	void locateNodeRegion(Node*);
	void computeCandidateRegion();
	void computeRNNAnswer(string, string, string, string, string, string, string, string, int);
	void computeKNNAnswer();
