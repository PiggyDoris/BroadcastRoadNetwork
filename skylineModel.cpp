...
void skylineModel::writeBNAndNNDist(string inputDir1, string inputDir2, string outputDir, int processCounter)
{
...
void skylineModel::precomputationIntegrate()
{
	...
	if (progressStep < 1)
	{
		cout << endl << "Please enter LIC_ROAD.geo" << endl;
		cin >> fileDir;//輸入檔案
	...
	if (progressStep < 8)
	{
		...
		{
			nsProcessCounter = 0;
			writeBNAndNNDist(outputFileDir + ".bntable", outputFileDir + ".objreg", outputFileDir, nsProcessCounter);
			writeBNAndNSDist(outputFileDir + ".bntable", outputFileDir + ".objreg", outputFileDir + ".spot", outputFileDir, nsProcessCounter);
		}
	...
	client->computeKNNAnswer(outputFileDir + ".objreg", outputFileDir + ".index", outputFileDir + ".nbnntable", outputFileDir + ".bb", outputFileDir + ".blist", outputFileDir + ".maxdist", outputFileDir + ".bnns", queryAmountK, startRegionId);
...
void skylineModel::writeBNAndNSDist(string inputDir1, string inputDir2, string inputDir3, string outputDir, int processCounter)
{
